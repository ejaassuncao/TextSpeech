...
public class ServletVoice extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		try {
			...
			// https://text-to-speech-demo.ng.bluemix.net/api/synthesize?voice=pt-BR_IsabelaVoice&text=Senha<break time="500ms"/><prosody rate="-15%">{senha}</prosody>Comparecer ao guich� {guiche}. <break time="1000ms"/>&X-WDC-PL-OPT-OUT=0
